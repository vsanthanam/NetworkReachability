...
## Usage
`
Basic usage of Reachability is the same regardless of your observability mechanism. Create a long-used instance of ``ReachabilityMonitor`` and retain it in memory. From there, you can access the `.currentStatus` property as needed, or observe changes using one of the mechanisms described below.
